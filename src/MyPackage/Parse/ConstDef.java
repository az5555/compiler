...
public class ConstDef {
    ...
    public void generateLlvm(boolean isGlobal) {
        if (isGlobal) {
            ...
            DeclLlvm declLlvm = new DeclLlvm(Type.MyConst, 0, symbol.getName(), true);
            if (constInitVal != null) {
                constInitVal.generateLlvm(declLlvm.getVal());
            }
            ...
            if (constInitVal != null) {
                ...
                constInitVal.generateLlvm2(values);
            ...
            ((MyValSymbol)symbol).setDeclLlvm(declLlvm);
